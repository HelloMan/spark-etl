...
grant SELECT, INSERT, UPDATE, DELETE ON BATCH_JOB_INSTANCE to ${USER_APP_RW_ROLE};
grant SELECT, INSERT, UPDATE, DELETE ON BATCH_JOB_EXECUTION to ${USER_APP_RW_ROLE};
grant SELECT, INSERT, UPDATE, DELETE ON BATCH_JOB_EXECUTION_PARAMS to ${USER_APP_RW_ROLE};
grant SELECT, INSERT, UPDATE, DELETE ON BATCH_STEP_EXECUTION to ${USER_APP_RW_ROLE};
grant SELECT, INSERT, UPDATE, DELETE ON BATCH_STEP_EXECUTION_CONTEXT to ${USER_APP_RW_ROLE};
grant SELECT, INSERT, UPDATE, DELETE ON BATCH_JOB_EXECUTION_CONTEXT to ${USER_APP_RW_ROLE};
grant SELECT, INSERT, UPDATE, DELETE ON SVC_SERVICE_REQUEST to ${USER_APP_RW_ROLE};
grant SELECT, INSERT, UPDATE, DELETE ON DATASET_SCHEMA to ${USER_APP_RW_ROLE};
grant SELECT, INSERT, UPDATE, DELETE ON DATASET_SCHEMA_FIELD to ${USER_APP_RW_ROLE};
grant SELECT, INSERT, UPDATE, DELETE ON STAGING_DATA_SET to ${USER_APP_RW_ROLE};
grant SELECT, INSERT, UPDATE, DELETE ON DATASET to ${USER_APP_RW_ROLE};
grant SELECT, INSERT, UPDATE, DELETE ON DATA_QUALITY_CHECK_EXECUTION to ${USER_APP_RW_ROLE};